...
- [User Docs](./usernote/README.md): user-facing overview, concepts, and language reference
- [Specs](./specs/README.md): design drafts and deeper implementation proposals
