...
- Added the Shop Security Boundaries v1 public contract doc, tying generated shop session/auth/CSRF/rate-limit/checkout/webhook boundaries to existing source-order, runtime, artifact, and smoke regressions.
